...
const linkedinLink = "https://linkedin.com/in/artyomsukiasyan/";
const telegramLink = "https://t.me/artyom1401";
const githubLink = "https://github.com/ArtyomSukiasyan";

export const SOCIAL_LINKS = [
    { href: linkedinLink, path: linkedInPath, name: "Linkedin" },
    { href: githubLink, path: githubPath, name: "Github" },
    { href: telegramLink, path: telegramPath, name: "Telegram" },
];
